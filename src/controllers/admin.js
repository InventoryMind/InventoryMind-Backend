...
exports.getDashboardData=async (req,res)=>{
  ...
  exports.getRequestStats= async (req,res)=>{
    const admin= new Admin({email:req.user.mail,userType:req.user.userType,userId:req.user.userId});
    const result = await admin.getRequestStats();
  ...
  exports.getUserStats= async (req,res)=>{
    const admin= new Admin({email:req.user.mail,userType:req.user.userType,userId:req.user.userId});
    const result = await admin.getUserStats();
  ...
  exports.getEquipStats=async (req,res)=>{
    const admin= new Admin({email:req.user.email,userType:req.user.userType,userId:req.user.userId});
    const result = await admin.getEquipStats();
    // console.log(result);
    if (result.connectionError){
        return res.status(500).json({
            msg:"connection error"
